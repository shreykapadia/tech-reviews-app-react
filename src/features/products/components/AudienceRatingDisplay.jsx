...
const AudienceRatingDisplayComponent = ({ scoreOutOf100, reviewCount }) => {
...
AudienceRatingDisplayComponent.propTypes = {
  scoreOutOf100: PropTypes.number, // Direct score from 0-100
  reviewCount: PropTypes.number,   // Total number of reviews
};

AudienceRatingDisplayComponent.defaultProps = {
  scoreOutOf100: null,
  reviewCount: 0,
};

const AudienceRatingDisplay = React.memo(AudienceRatingDisplayComponent);
AudienceRatingDisplay.displayName = 'AudienceRatingDisplay';
