  ...
  const checkProductAgainstCriterion = (product, questionId, answerValue, categoryName, categoryQuestions) => {
    ...
    if (categoryName === 'TVs') {
      ...
      if (Array.isArray(answerValue)) { // Handles multiselect_checkbox for generic fields
        // Already handled 'any' and empty array at the start of the function
        // This assumes productValue is a single value that needs to be one of the selected options
        // or productValue is an array and should intersect with answerValue.
        // For simplicity, let's assume productValue is a single value here.
